<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO product (product_name,product_price,product_image,product_code)VALUES('$p_name','$p_price','$target_file','$p_code')";
        $conn = mysqli_connect('localhost','root',"",'cartsystem'); 
        if(mysqli_query($conn,$sql)){
            $msg="New menu has been added successfully!";
        }
        else{
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO staffproduct (product_name,product_price,product_image,product_code)VALUES('$p_name','$p_price','$target_file','$p_code')";
...
<body style="background-color:powderblue;">
    ...
    <div class="container1">
        <div class="row justify-content-center" style="width: 1000px;">
            <div class="col-md-6 bg-light mt-5 rounded" style="left: -220px;">
                ...
                <form action="" method="post" class="p-2" enctype="multipart/form-data" id="form-box">
                    ...
                    <div class="form-group">
                        <input type="number" min="1" name="pPrice" class="form-control" placeholder="Product Price" required>
                    </div>
                    <div class="form-group">
